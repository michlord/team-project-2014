#ifndef GAME_ENTITY_CHARACTERENTITY_STATES_MOVEMENT_IDLE_H_INCLUDED
#define GAME_ENTITY_CHARACTERENTITY_STATES_MOVEMENT_IDLE_H_INCLUDED
...
class Idle : public State<CharacterEntity> {
private:
public:
...
#endif // GAME_ENTITY_CHARACTERENTITY_STATES_MOVEMENT_IDLE_H_INCLUDED
