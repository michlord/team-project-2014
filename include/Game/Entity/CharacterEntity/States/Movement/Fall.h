#ifndef GAME_ENTITY_CHARACTERENTITY_STATES_MOVEMENT_FALL_H_INCLUDED
#define GAME_ENTITY_CHARACTERENTITY_STATES_MOVEMENT_FALL_H_INCLUDED
...
namespace Entity {
    ...
    class Fall : public State<CharacterEntity> {
    private:
    public:
...
#endif // GAME_ENTITY_CHARACTERENTITY_STATES_MOVEMENT_FALL_H_INCLUDED
