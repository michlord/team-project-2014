#ifndef GAME_ENTITY_CHARACTERENTITY_STATES_MOVEMENT_ONGROUND_H_INCLUDED
#define GAME_ENTITY_CHARACTERENTITY_STATES_MOVEMENT_ONGROUND_H_INCLUDED
...
namespace Entity {
    ...
    class OnGround : public State<CharacterEntity> {
    private:
    public:
...
#endif // GAME_ENTITY_CHARACTERENTITY_STATES_MOVEMENT_ONGROUND_H_INCLUDED
