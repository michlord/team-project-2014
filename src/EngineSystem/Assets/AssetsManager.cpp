...
namespace Assets {
	...
	bool AssetsManager::loadTexture(const std::string& fileName, const ID& id) {
	...
	bool AssetsManager::loadFont(const std::string& fileName, const ID& id) { 
	...
	sf::Texture& AssetsManager::getTexture(const ID& id) {
	...
	sf::Font& AssetsManager::getFont(const ID& id) {
